...
window.centersText = [' hi '];
var textForRandomChars = [
    'East Africa', 'Food Insecurity', 'Drought', 'Food Aid', 'Somalia', 'Ethiopia', 'Tigray', 'Russian Invasion of Ukraine (2022)', 'Kenya', 'Sudan', 'Russia', 'Ukraine', 'International Trade and World Market', 'Commodities', 'Prices (Fares, Fees and Rates)'
...
function draw() {
    ...
    charsArr.forEach(function(charNodeItem) {
        charNodeItem.calcNewPos().drawLine();
    });
    charsArr.forEach(function(charNodeItem) {
        charNodeItem.drawChar();
    });
}
